...
trait Entity implements Serializable{
    ...
    /**
     * Used to simulate the common static equals check: other instanceof CurrentClass, where CurrentClass is the implementer of the Entity trait. Entities must
