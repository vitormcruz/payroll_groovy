package com.vmc.payroll.external.converter
...
class JsonConversionExtensions {
    ...
    private static final writerOptions = [(FIELD_NAME_BLACK_LIST): [(Employee): ["addressMandatory",
                                                                                 "nameMandatory",
                                                                                 "emailMandatory",
                                                                                 "paymentAttachmentListeners"]]
                                        ]
